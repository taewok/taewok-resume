      ...
      <main>
        ...
        <div className="myprofile-box">
          <ul className="myinfo-list">
            ...
            <li className="myinfo-item">
              <span>Portfolio</span>:
              <a
                href="https://taewok-portfolio.netlify.app"
                target="_blank"
                rel="noreferrer"
              >
                https://taewok-portfolio.netlify.app
              </a>
            </li>
          </ul>
        ...
        <section className="introduce-box">
          ...
          <div className="introduce-text-box">
            <p>
              안녕하세요 2년간 개발에 열정을 갖고 꾸준한 노력으로 매일 성장해온
              <br /> 프론트엔드 개발자 <b>"김태욱"</b>입니다.
              <br />
              <br />
              저는 코드의 성능 향상을 위한 코드와 알고리즘에 관심이 많아
              적극적으로 학습하며 인상 깊은 코드 혹은 기술은 Github 블로그를
              통해 기록해가며 성장하고 있습니다.
              <br />
              <br />
              사용자에게 편하고 부드러운 인터페이스와 경험을 중요하게 생각하며
              그러기 위한 과정에서 팀원 간의 소통을 핵심으로 여기고 있으며
              <br />
            ...
            <div className="project-detail-box">
              ...
              <ul className="role-list">
                <li className="role-item">
                  react-query와 throttle를 사용해 일정 스크롤시 데이터를 추가로
                  받아오는 무한스크롤
                </li>
                <li className="role-item">
                  Github Rest API를 활용한 github연동 및 정보 표현
                </li>
                <li className="role-item">
        ...
        <section className="skill-box">
          ...
          <ul className="skill-explain-list">
            <li className="skill-explain-item">ES6 이상 문법을 적극 사용</li>
            <li className="skill-explain-item">
              Vanilla JS를 이용한 DOM 객체의 조작
            </li>
            <li className="skill-explain-item">
              Axios 기반의 Rest API 서버 통신 및 데이터 처리
            </li>
            <li className="skill-explain-item">
              async/await, Promise 등을 활용한 비동기 작업 처리
            </li>
            <li className="skill-explain-item">
          ...
          <ul className="skill-explain-list">
            <li className="skill-explain-item">JSX 문법 이해</li>
            ...
            <li className="skill-explain-item">
              리액트 라우터(React Router)를 이용한 모듈단위 라우팅 구조 설계
            </li>
          </ul>
        </section>
